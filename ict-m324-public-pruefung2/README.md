...
- Der Workflow sollte auf github.com jetzt starten, es gibt jedoch einen Fehler beim Linter. Fixen Sie den Fehler und erstellen Sie einen Commit. Der Workflow sollte jetzt funktionieren und die Nachricht "All checks have passed" anzeigen.
- **Commit Messages**:
